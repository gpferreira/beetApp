...
class BeetHeaderAndroid extends Component {
...
class BeetHeaderIOS extends Component {
    static height: number;
    props: Props;

    render() {
        const {leftItem, title, rightItem, foreground} = this.props;
        const titleColor = foreground === 'dark' ? BeetColors.darkText : 'white';
        const itemsColor = foreground === 'dark' ? BeetColors.lightText : 'white';
...
const Header = Platform.OS === 'ios' ? BeetHeaderIOS : BeetHeaderAndroid;
