...
import BeetViewPager from './BeetViewPager'
import { Text } from './BeetText';
import BeetSegmentedControl from './BeetSegmentedControl';
import BeetParallaxBackground from './BeetParallaxBackground';
import BeetHeader from './BeetHeader';

let StyleSheet = require('./BeetStyleSheet');

import type {Item as HeaderItem} from './BeetHeader';
...
class BeetListContainer extends Component {
    props: Props;
    state: State;
    _refs: Array<any>;
    _pinned: any;
        ...
        return (
            <View style={styles.container}>
                <View style={styles.headerWrapper}>
                    <BeetParallaxBackground
                        minHeight={this.state.stickyHeaderHeight + BeetHeader.height}
                        maxHeight={EMPTY_CELL_HEIGHT + this.state.stickyHeaderHeight + BeetHeader.height}
...
const styles = StyleSheet.create({
    ...
    stickyHeader: {
        position: 'absolute',
        top: BeetHeader.height,
        left: 0,
        right: 0,
    },
});

export default BeetListContainer;
